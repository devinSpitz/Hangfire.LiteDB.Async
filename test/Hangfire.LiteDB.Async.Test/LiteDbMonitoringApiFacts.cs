...
#pragma warning disable 1591
    ...
    public class LiteDbMonitoringApiFacts
    {
        ...
        [CleanDatabase]
        public async Task
            ProcessingJobs_ReturnsProcessingJobsOnly_WhenMultipleJobsExistsInProcessingSucceededAndEnqueuedState()
        {
            var tmp = UseMonitoringApi();
            var database = tmp.Item1;
            var monitoringApi = tmp.Item2;
        ...
        private async Task<LiteJob> CreateJobInState(HangfireDbContextAsync database, int jobId, string stateName,
            Func<LiteJob, LiteJob> visitor = null)
        {
            ...
            if (visitor != null) liteJob = visitor(liteJob);
            ...
            if (stateName == FetchedStateName) jobQueueDto.FetchedAt = DateTime.UtcNow;
