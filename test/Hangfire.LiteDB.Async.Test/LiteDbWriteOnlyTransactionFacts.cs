...
#pragma warning disable 1591
    ...
    public class LiteDbWriteOnlyTransactionFacts
    {
        ...
        {
            var defaultProvider = new Mock<IPersistentJobQueueAsyncProvider>();
        ...
        {
            var exception =
                Assert.Throws<ArgumentNullException>(() => new LiteDbWriteOnlyTransactionAsync(null, _queueProviders));
        ...
        public void Ctor_ThrowsAnException_IfProvidersCollectionIsNull()
        {
            var exception = Assert.Throws<ArgumentNullException>(() =>
                new LiteDbWriteOnlyTransactionAsync(ConnectionUtils.CreateConnection(), null));
        ...
        public async Task IncrementCounter_AddsRecordToCounterTable_WithPositiveValue()
        {
            ...
            var record = (await database.StateDataCounter.FindAllAsync()).ToList().Single();
        ...
        public async Task AddToSet_AddsARecord_IfThereIsNo_SuchKeyAndValue()
        {
            ...
            var record = (await database.StateDataSet.FindAllAsync()).ToList().Single();
        ...
        public async Task InsertToList_AddsARecord_WithGivenValues()
        {
            ...
            var record = (await database.StateDataList.FindAllAsync()).ToList().Single();
